...
export const NotAlone: NextPage = () => {
  return (
    <div className="px-6 md:pb-60">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 overflow-hidden rounded-lg px-5 py-8 md:flex-row md:border md:border-outline-secondary md:px-16">
        <div className="flex flex-col items-center gap-6 md:w-[50%] md:items-start lg:max-w-[590px]">
          <div className="flex flex-col gap-10">
            <h4 className="text-primary-text text-center text-2xl md:text-3xl leading-tight font-semibold md:text-left">

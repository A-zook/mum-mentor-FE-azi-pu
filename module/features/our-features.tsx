...
const features = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M30.7827 28.0499L31.4327 33.3166C31.5993 34.6999 30.116 35.6666 28.9327 34.9499L23.166 31.5166C22.766 31.2833 22.666 30.7833 22.8827 30.3833C23.716 28.8499 24.166 27.1166 24.166 25.3833C24.166 19.2833 18.9327 14.3166 12.4993 14.3166C11.1827 14.3166 9.89933 14.5166 8.69933 14.9166C8.08267 15.1166 7.48267 14.5499 7.63267 13.9166C9.14933 7.84992 14.9827 3.33325 21.9493 3.33325C30.0827 3.33325 36.666 9.48325 36.666 17.0666C36.666 21.5666 34.3493 25.5499 30.7827 28.0499Z"
          fill="white"
        />
        <path
          d="M21.6673 25.3833C21.6673 27.3666 20.934 29.2 19.7007 30.65C18.0507 32.65 15.434 33.9333 12.5007 33.9333L8.15065 36.5166C7.41732 36.9667 6.48398 36.35 6.58398 35.5L7.00065 32.2167C4.76732 30.6666 3.33398 28.1833 3.33398 25.3833C3.33398 22.45 4.90065 19.8667 7.30065 18.3333C8.78398 17.3667 10.5673 16.8167 12.5007 16.8167C17.5673 16.8167 21.6673 20.65 21.6673 25.3833Z"
          fill="white"
        />
      </svg>
    ),
  ...
  return (
    <div className="mx-auto my-[50px] px-6">
      <div className="mx-auto flex w-[368px] flex-col gap-4 py-6 md:w-[750px]">
        <p className="md:text-heading2 text-soft-black font-hanken text-center text-[32px] font-semibold">
          Our Features
        </p>
      ...
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 py-[50px] md:grid-cols-2">
